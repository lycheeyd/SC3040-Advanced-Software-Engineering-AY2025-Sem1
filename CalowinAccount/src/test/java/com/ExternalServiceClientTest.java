...
// Provide a dummy property for the URL prefix, as it's required by the client
// bean
...
class ExternalServiceClientTest {
    ...
    void getFriendStatus_whenApiReturnsSuccess_shouldReturnFriendStatus() throws Exception {
        ...
        mockServer.expect(requestTo(expectedUrl))
                ...
                .andRespond(
                        withSuccess(objectMapper.writeValueAsString(FriendStatus.FRIEND), MediaType.APPLICATION_JSON));
