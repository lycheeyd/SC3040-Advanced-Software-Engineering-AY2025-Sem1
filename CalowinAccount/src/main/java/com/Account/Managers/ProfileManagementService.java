...
public class ProfileManagementService {
        ...
        public ViewProfileResponseDTO viewProfile(String selfID, String otherID) throws Exception {
                ...
                return new ViewProfileResponseDTO(profile.getUserID(), profile.getName(), profile.getBio(),
                                friendStatus,
                                achievement.getTotalCarbonSaved(), achievement.getTotalCalorieBurnt(),
                                achievement.getCarbonMedal(), achievement.getCalorieMedal());
