...
class AchievementServiceTest {
    ...
    void addTripMetrics_whenUserExists_shouldUpdateExistingAchievement() {
        ...
        assertThat(savedAchievement.getTotalCarbonSavedExp()).isEqualTo(initialCarbonExp + carbonToAdd); // 100 + 50 =
                                                                                                         // 150
        assertThat(savedAchievement.getTotalCalorieBurntExp()).isEqualTo(initialCalorieExp + caloriesToAdd); // 200 + 75
                                                                                                             // = 275
